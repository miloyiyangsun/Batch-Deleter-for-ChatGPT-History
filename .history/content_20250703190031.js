...
async function hoverAndClickButtonsSequentially() {
    ...
    for (let i = 0; i < numberOfButtons; i++) {
        ...
        console.log(`[步骤 1/3] 正在悬停在第 ${i + 1} 个项目上...`);
        ...
        console.log(`[步骤 2/3] 正在对第 ${i + 1} 个"选项"按钮执行 pointerdown 操作以打开菜单...`);
        ...
        console.log(`[步骤 3/3] 正在查找第 ${i + 1} 项对应的"删除"按钮...`);
        ...
        // 在处理完一个项目后，等待一下再进入下一个，也让菜单有时间关闭。
        await delay(500);
    }
